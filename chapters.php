<?php
         ...
         $sql="Select Story_Title from Story where Story_ID='$storyId'";
	...
	<body>
		...
		<div class="header" id="home">
			...
			<div class="header-banner">
					<!-- Top Navigation -->
					<section class="bgi banner5"><h2><?echo $storyTitle;?></h2> </section>
             ...
             <div class="bs-example">
                 <table class="table">
	              ...
	              <? while($row = mysql_fetch_array($retval, MYSQL_ASSOC))
			         {  ?>			          
			                <tr>
	                      		<td><a href=<? echo "chapterdetail.php?chapterId=".$row['Chapter_ID'];  ?>><h1><? echo $row['Chapter_Title'];  ?></a></h1></td>
	                    	</tr>
			      <? } ?>
                  </tbody>
                 </table>
